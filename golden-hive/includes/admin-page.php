...
<?php if ( $show_feed_ui ) : ?>
            <div class="tab-section">FEED</div>
...
<?php endif; ?>
            ...
            <div class="tab-item" onclick="GH.switchTab('bulkimport',this)"><span class="tab-icon">&#8615;</span><span class="tab-label">Import JSON</span></div>
